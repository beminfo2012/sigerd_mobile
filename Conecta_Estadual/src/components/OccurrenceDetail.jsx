...
const OccurrenceDetail = ({ occurrence, onClose, onUpdate }) => {
    ...
    const statusOptions = [
        ...
        { value: 'Monitoramento', label: 'Em Monitoramento', color: 'bg-amber-50 text-amber-700 border-amber-100' },
        { value: 'Concluído', label: 'Concluído', color: 'bg-slate-50 text-slate-700 border-slate-100' },
    ];
