            ...
            <main className="flex flex-col items-center pt-20 print:pt-0 w-full print-preview-wrapper">
                <div className="w-[210mm] bg-white print:shadow-none shadow-2xl min-h-[297mm] p-10 md:p-14 print:p-0 mb-10 print:mb-0 relative print-container">
                    ...
                    <header className="flex flex-col items-center mb-10 border-b-4 border-[#2a5299] pb-6">
                        ...
                        <h1 className="text-2xl font-black text-[#2a5299] uppercase tracking-wide text-center">Relatório de Ocorrência</h1>
                        <div className="flex items-center gap-2 text-[10px] font-bold text-slate-500 uppercase tracking-widest bg-slate-50 px-4 py-1.5 rounded-full border border-slate-100 mt-2">
                            ...
                            <span>•</span>
                            <span>ID: {data.ocorrencia_id_format || data.ocorrencia_id_format || '---'}</span>
                        </div>
                    </header>
                    ...
                    <section className="mb-8 avoid-break">
                        ...
                        <div className="flex flex-col gap-2">
                            <div className="p-3 border border-slate-200 rounded-lg bg-orange-50">
                                ...
                                <p className="font-black text-slate-800 text-sm">{data.categoriaRisco || data.categoria_risco || data.tipo_info || data.tipoInfo || data.riscoTipo || data.risco_tipo || 'Não Classificado'}</p>
                            </div>

                            <div className="grid grid-cols-2 gap-2">
                                <div className="p-3 border border-slate-200 rounded-lg">
                                    <p className="text-[9px] font-bold text-slate-400 uppercase mb-1">Nível de Risco</p>
                                    <span className={`text-xs font-black uppercase px-2 py-0.5 rounded border ${(data.nivelRisco === 'Alto' || data.nivelRisco === 'Iminente' || data.nivel_risco === 'Alto' || data.nivel_risco === 'Iminente') ? 'bg-red-100 text-red-700 border-red-200' :
                                        (data.nivelRisco === 'Médio' || data.nivel_risco === 'Médio') ? 'bg-yellow-100 text-yellow-700 border-yellow-200' :
                            ...
                            <div className="p-3 border border-slate-200 rounded-lg flex-1">
                                ...
                                <div className="flex flex-wrap gap-1">
                                    {(() => {
                                        ...
                                        return <span className="text-[10px] text-slate-400 italic">Nenhum subtipo listado.</span>;
                                    })()}
                                </div>
                            </div>
                        </div>
                    ...
                    {checklistItems.length > 0 && (
                        <section className="mb-8 avoid-break">
                            <div className="flex items-center gap-2 mb-3">
                                ...
                                <h2 className="text-sm font-black text-slate-800 uppercase tracking-widest">{numChecklist}. Checklist Técnico</h2>
                            </div>
