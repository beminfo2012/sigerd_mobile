            ...
            <div className="max-w-6xl mx-auto px-4 py-6">
                ...
                <div className="flex flex-col gap-4 mb-6">
                    ...
                    <div className="flex items-center justify-between gap-4">
                        <div>
                            <h1 className="text-2xl font-black text-slate-800 dark:text-slate-100 dark:text-white">Estoque Municipal</h1>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-6">
                    <Card className="p-4 text-center">
                        ...
                        <p className="text-2xl font-black text-slate-800 dark:text-slate-100 dark:text-white">{new Set(allItems.map(i=>i.item_name)).size}</p>
                        <p className="text-[10px] text-slate-500 dark:text-slate-400 font-semibold uppercase">Tipos</p>
                    </Card>
                    <Card className="p-3 text-center">
                        <TrendingUp size={18} className="mx-auto text-emerald-500 mb-1" />
                        <p className="text-lg font-black text-slate-800 dark:text-slate-100 dark:text-white">{totalItems.toLocaleString('pt-BR')}</p>
                        <p className="text-[10px] text-slate-500 dark:text-slate-400 font-semibold uppercase">Total Qtd</p>
                    </Card>
                    <Card className={`p-3 text-center ${lowStockCount > 0 ? 'border-amber-200 dark:border-amber-500/30' : ''}`}>
                        ...
                        <p className={`text-lg font-black ${lowStockCount > 0 ? 'text-amber-600' : 'text-slate-800 dark:text-slate-100 dark:text-white'}`}>{lowStockCount}</p>
                        <p className="text-[10px] text-slate-500 dark:text-slate-400 font-semibold uppercase">Estoque Baixo</p>
                    </Card>
                </div>
                        ...
                        >
                            <div className="flex items-center gap-3">
                                ...
                                <div className="text-left">
                                    <p className="text-sm font-bold text-slate-800 dark:text-slate-100 dark:text-white">
                        ...
                        {showConsistency && (
                            <div className="px-4 pb-4 pt-0 border-t border-slate-100 dark:border-slate-800">
                                <div className="grid grid-cols-2 gap-3 mt-3">
                                    <div className="bg-emerald-50 dark:bg-emerald-900/20 dark:bg-emerald-500/10 rounded-xl p-3">
                                    ...
                                    <div className="bg-blue-50 dark:bg-blue-900/20 dark:bg-blue-500/10 rounded-xl p-3">
                                        <div className="flex items-center gap-2 mb-1">
                                    ...
                                    <div className="bg-slate-50 dark:bg-slate-800/50 dark:bg-slate-800 rounded-xl p-3">
                                        <div className="flex items-center gap-2 mb-1">
                                            <BarChart3 size={14} className="text-slate-600 dark:text-slate-300" />
                                            <span className="text-xs font-bold text-slate-600 dark:text-slate-300 dark:text-slate-400">Saldo Esperado</span>
                                        </div>
                                        <p className="text-xl font-black text-slate-700 dark:text-slate-200 dark:text-slate-300">{consistency.expectedStock.toLocaleString('pt-BR')}</p>
                                    </div>
                                    <div className={`rounded-xl p-3 ${consistency.isConsistent ? 'bg-emerald-50 dark:bg-emerald-900/20 dark:bg-emerald-500/10' : 'bg-amber-50 dark:bg-amber-900/20 dark:bg-amber-500/10'}`}>
                                        <div className="flex items-center gap-2 mb-1">
                                ...
                                {consistency.incompleteDonations > 0 && (
                                    <div className="mt-3 flex items-center gap-2 bg-red-50 dark:bg-red-900/20 dark:bg-red-500/10 rounded-xl p-3">
                ...
                <div className="flex gap-2 mb-4">
                    <div className="flex-1 relative">
                        ...
                        <input
                            ...
                            className="w-full pl-10 pr-4 py-3 bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-2xl text-slate-800 dark:text-slate-100 dark:text-white placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-[#2a5299]/20 transition-all text-sm font-semibold"
                        />
                    </div>
                    {categories.length > 0 && (
                        <select
                            ...
                            className="bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-2xl px-3 text-sm font-semibold text-slate-700 dark:text-slate-200 dark:text-slate-300"
                        >
                ...
                {/* Accordion Tabs */}
                <div className="flex bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-700 dark:border-slate-800 p-1 mb-6">
                    <button 
                        onClick={() => setActiveTab('CENTRAL')}
                        className={`flex-1 py-3 text-sm font-bold rounded-xl transition-all ${activeTab === 'CENTRAL' ? 'bg-blue-600 text-white shadow-md' : 'text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:bg-slate-800 dark:text-slate-300 dark:hover:bg-slate-800'}`}
                    >
                        Estoque Central ({centralItems.length})
                    </button>
                    <button 
                        onClick={() => setActiveTab('SHELTERS')}
                        className={`flex-1 py-3 text-sm font-bold rounded-xl transition-all ${activeTab === 'SHELTERS' ? 'bg-emerald-600 text-white shadow-md' : 'text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:bg-slate-800 dark:text-slate-300 dark:hover:bg-slate-800'}`}
                    >
                                    ...
                                    {isEditing ? (
                                        ...
                                        <div className="p-4 space-y-3 bg-blue-50 dark:bg-blue-900/20 dark:bg-blue-500/5">
                                            ...
                                            <input
                                                ...
                                                className="w-full px-3 py-2 rounded-xl bg-white dark:bg-slate-900 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-sm font-semibold text-slate-800 dark:text-slate-100 dark:text-white"
                                            ...
                                            <div className="grid grid-cols-2 gap-2">
                                                <input
                                                    ...
                                                    className="px-3 py-2 rounded-xl bg-white dark:bg-slate-900 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-sm font-semibold text-slate-800 dark:text-slate-100 dark:text-white"
                                        ...
                                        <div className="p-4">
                                            <div className="flex items-start gap-3">
                                                <div className={`p-2.5 rounded-xl flex-shrink-0 ${isLow ? 'bg-amber-50 dark:bg-amber-900/20 dark:bg-amber-500/10' : 'bg-blue-50 dark:bg-blue-900/20 dark:bg-blue-500/10'}`}>
                                                    <Package size={18} className={isLow ? 'text-amber-600' : 'text-blue-600'} />
                                                </div>
                                                <div className="flex-1 min-w-0">
                                                    <h3 className="text-sm font-bold text-slate-800 dark:text-slate-100 dark:text-white truncate">
                                            ...
                                            <div className="flex gap-2 mt-3 pt-3 border-t border-slate-100 dark:border-slate-800">
                                                <button
                                                    ...
                                                    className="flex-1 flex items-center justify-center gap-1.5 py-2 rounded-xl text-xs font-bold text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-900/20 dark:bg-blue-500/10 hover:bg-blue-100 dark:hover:bg-blue-500/20 transition-colors"
                                                >
                                                    <Edit3 size={13} /> Editar
                                                </button>
                                                <button
                                                    onClick={() => showHistory(item)}
                                                    className="flex-1 flex items-center justify-center gap-1.5 py-2 rounded-xl text-xs font-bold text-slate-600 dark:text-slate-300 dark:text-slate-400 bg-slate-50 dark:bg-slate-800/50 dark:bg-slate-800 hover:bg-slate-100 dark:bg-slate-800 dark:hover:bg-slate-700 transition-colors"
                                                >
                                                    <History size={13} /> Histórico
                                                </button>
                                                <button
                                                    onClick={() => setShowDeleteModal(item)}
                                                    className="flex items-center justify-center gap-1.5 py-2 px-3 rounded-xl text-xs font-bold text-red-600 dark:text-red-400 bg-red-50 dark:bg-red-900/20 dark:bg-red-500/10 hover:bg-red-100 dark:bg-red-900/30 dark:hover:bg-red-500/20 transition-colors"
                                                >
                                                    <Trash2 size={13} />
                                                </button>
                                            </div>
                ...
                {centralItems.length > 0 && activeTab === 'CENTRAL' && (
                    <div className="mt-6 pt-6 border-t border-slate-200 dark:border-slate-700 dark:border-slate-800">
                        <button
                            onClick={() => setShowClearModal(true)}
                            className="w-full md:w-auto px-8 mx-auto flex items-center justify-center gap-2 py-3 rounded-2xl text-sm font-bold text-red-500 hover:bg-red-50 dark:bg-red-900/20 dark:hover:bg-red-500/10 transition-colors"
                        >
                ...
                <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-end sm:items-center justify-center z-[100]" onClick={() => setHistoryItem(null)}>
                    ...
                    >
                        <div className="flex items-center justify-between mb-4">
                            <div>
                                <h3 className="text-lg font-black text-slate-800 dark:text-slate-100 dark:text-white">Histórico de Movimentações</h3>
                                <p className="text-xs text-slate-500 dark:text-slate-400 font-semibold">{historyItem.item_name}</p>
                            </div>
                            <button onClick={() => setHistoryItem(null)} className="p-2 text-slate-400 hover:bg-slate-100 dark:bg-slate-800 dark:hover:bg-slate-800 rounded-full">
                                <X size={20} />
                            </button>
                        </div>
                        ...
                        {movements.length === 0 ? (
                            ...
                            <div className="space-y-3">
                                {movements.map((m, i) => (
                                    <div key={i} className={`flex items-start gap-3 p-3 rounded-xl ${m.type === 'entrada' ? 'bg-emerald-50 dark:bg-emerald-900/20 dark:bg-emerald-500/10' : 'bg-blue-50 dark:bg-blue-900/20 dark:bg-blue-500/10'}`}>
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <p className="text-xs font-bold text-slate-700 dark:text-slate-200 dark:text-slate-300 truncate">{m.description}</p>
