        ...
        <div className="h-full flex flex-col bg-slate-950 overflow-hidden relative">
            ...
            <div className="absolute top-3 left-3 right-3 z-[1000] pointer-events-none">
                <div className="flex flex-col gap-2.5">
                    <div className="flex justify-between items-center bg-white/40 backdrop-blur-2xl p-2 rounded-2xl shadow-xl pointer-events-auto border border-white/20">
                    ...
                    <div className="flex gap-2 overflow-x-auto pb-2 scrollbar-none pointer-events-auto px-1 -mx-1">
                        <div className="flex bg-white/40 backdrop-blur-2xl p-1.5 rounded-xl shadow-lg border border-white/20 gap-1 shrink-0">
            ...
            <div className="absolute bottom-4 left-3 right-3 z-[1000] pointer-events-none">
                <div className="bg-slate-900/40 backdrop-blur-2xl border border-white/10 p-4 rounded-[28px] shadow-2xl pointer-events-auto flex items-center justify-between">
