        ...
        <div className="bg-slate-100 min-h-screen font-sans text-slate-800 print:bg-white print:p-0 p-8 flex justify-center">
             <style>{`
                @media print {
                    ...
                    .print-container { width: 100% !important; max-width: 100% !important; padding: 0 !important; margin: 0 !important; box-shadow: none !important; }
                                ...
                                <div className="grid grid-cols-2 gap-2">
                                    <div className="p-3 border border-slate-200 rounded-lg">
                                        ...
                                        <span className={`text-xs font-black uppercase px-2 py-0.5 rounded border ${
                                            (data.nivelRisco === 'Alto' || data.nivelRisco === 'Iminente') ? 'bg-red-100 text-red-700 border-red-200' : 
