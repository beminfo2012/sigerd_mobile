        ...
        <div className="bg-slate-50 dark:bg-slate-900 min-h-screen p-5 pb-24 font-sans transition-colors duration-300">
            ...
            <div className="space-y-4">
                ...
                {['Admin', 'Administrador', 'administrador', 'Agente de Defesa Civil', 'Coordenador', 'Coordenador de Proteção e Defesa Civil', 'admin'].includes(userProfile?.role) && (
                    <div className="md:hidden bg-white dark:bg-slate-800 rounded-[32px] shadow-[0_8px_30px_rgb(0,0,0,0.02)] border border-slate-100 dark:border-slate-700 overflow-hidden">
                        <button
                            onClick={() => window.location.href = '/alertas-cemaden'}
                            className="w-full p-5 flex items-center justify-between hover:bg-orange-50 dark:hover:bg-orange-900/20 transition-colors text-left"
                        >
                            <div className="flex items-center">
                                <div className="p-3 bg-orange-50 dark:bg-orange-900/30 text-orange-600 rounded-2xl mr-4">
                                ...
                                <div className="flex-1">
                                    <span className="block font-bold text-slate-800 dark:text-slate-100 text-sm">Alertas CEMADEN</span>
                                    <span className="text-[10px] font-black text-orange-500 uppercase tracking-widest">Painel Operacional</span>
                                </div>
                            </div>
                            <div className="bg-orange-50 dark:bg-orange-900/30 text-orange-600 dark:text-orange-400 text-[9px] font-black px-2 py-1 rounded-lg uppercase">Novo</div>
                        </button>
                    </div>
                )}
