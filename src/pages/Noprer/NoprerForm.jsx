    ...
    return (
        <div className="bg-[#F1F5F9] dark:bg-slate-900 min-h-screen font-[Inter,sans-serif] pb-32">
            ...
            <div className="sticky top-0 z-20 bg-[#1F3B5C] text-white shadow-md">
                <div className="p-4 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        <button onClick={() => navigate('/noprer')} className="p-1 hover:bg-white dark:bg-slate-800/10 rounded-full transition-colors">
                            <ChevronLeft size={24} />
                        </button>
                        <div>
                        ...
                        <React.Fragment key={s.id}>
                            <div className="flex flex-col items-center gap-1 z-10 relative">
                                <div className={`w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold transition-colors ${
                                    step > s.id ? 'bg-[#86EFAC] text-[#166534] dark:text-green-400' : step === s.id ? 'bg-[#60A5FA] text-white ring-4 ring-[#60A5FA]/30' : 'bg-[#2E5C8A] text-white/50'
                                }`}>
            ...
            {(formData.nome_notificado || formData.grau_risco) && (
                <div className="bg-white dark:bg-slate-800 px-4 py-2 border-b text-xs flex gap-4 overflow-x-auto whitespace-nowrap shadow-sm">
                    {formData.nome_notificado && <span className="font-bold text-slate-700 dark:text-slate-300">Notificado: <span className="font-normal">{formData.nome_notificado}</span></span>}
                    {formData.tipo_risco && <span className="font-bold text-slate-700 dark:text-slate-300">Risco: <span className="font-normal">{formData.tipo_risco}</span></span>}
                    {formData.grau_risco && <span className="font-bold text-slate-700 dark:text-slate-300">Grau: <span className="font-black text-orange-600">{formData.grau_risco}</span></span>}
                </div>
            )}
            ...
            <div className="p-4 md:p-6 max-w-7xl mx-auto space-y-6 mt-4">
                ...
                {step === 1 && (
                    <div className="space-y-6 animate-in fade-in slide-in-from-right-4">
                        ...
                        <div className="bg-white dark:bg-slate-800 p-5 rounded-xl border border-[#E2E8F0] dark:border-slate-700 shadow-sm">
                            <h3 className="text-sm font-black text-[#1F3B5C] dark:text-slate-100 mb-3 flex items-center gap-2">
                                <Search size={16} className="text-blue-500"/> Origem (Opcional)
                            </h3>
                            
                            {formData.vistoria_numero ? (
                                <div className="bg-[#F0FDF4] dark:bg-green-900/30 border border-[#86EFAC] p-3 rounded-lg flex justify-between items-center">
                                    <div>
                                        <p className="text-[10px] text-[#166534] dark:text-green-400 font-bold uppercase">Vistoria Vinculada</p>
                                        <p className="text-sm font-black text-[#166534] dark:text-green-400">{formData.vistoria_numero}</p>
                                    </div>
                                ...
                                <button 
                                    ...
                                    className="w-full flex items-center justify-between p-3 border border-slate-300 dark:border-slate-600 rounded-lg text-sm bg-slate-50 dark:bg-slate-800/50 hover:bg-slate-100 dark:bg-slate-800 transition-colors text-slate-600 dark:text-slate-400"
                                >
                        ...
                        <div className="bg-white dark:bg-slate-800 p-5 rounded-xl border border-[#E2E8F0] dark:border-slate-700 shadow-sm space-y-4">
                            <h3 className="text-sm font-black text-[#1F3B5C] dark:text-slate-100 border-b pb-2">Dados do Responsável / Imóvel</h3>
                            
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    <label className="text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-widest block mb-1">Nome Completo *</label>
                                    <input type="text" value={formData.nome_notificado} onChange={e => setFormData(p => ({...p, nome_notificado: e.target.value}))} className="w-full p-3 border border-slate-300 dark:border-slate-600 rounded-lg text-sm outline-none focus:border-blue-500" />
                                </div>
                                <div>
                                    <label className="text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-widest block mb-1">CPF / CNPJ *</label>
                                    <input type="text" value={formData.cpf_notificado} onChange={e => setFormData(p => ({...p, cpf_notificado: applyCpfCnpjMask(e.target.value)}))} placeholder="000.000.000-00" className="w-full p-3 border border-slate-300 dark:border-slate-600 rounded-lg text-sm outline-none focus:border-blue-500" />
                                </div>
                                <div>
                                    <label className="text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-widest block mb-1">Telefone</label>
                                    <input type="text" value={formData.contato} onChange={e => setFormData(p => ({...p, contato: applyPhoneMask(e.target.value)}))} placeholder="(27) 99999-9999" className="w-full p-3 border border-slate-300 dark:border-slate-600 rounded-lg text-sm outline-none focus:border-blue-500" />
                                </div>
                                <div>
                                    <label className="text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-widest block mb-1">Condição *</label>
                                    <select value={formData.condicao} onChange={e => setFormData(p => ({...p, condicao: e.target.value}))} className="w-full p-3 border border-slate-300 dark:border-slate-600 rounded-lg text-sm outline-none focus:border-blue-500 bg-white dark:bg-slate-800">
                                ...
                                <div className="md:col-span-2">
                                    <label className="text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-widest block mb-1">Endereço Completo *</label>
                                    <input type="text" value={formData.endereco} onChange={e => setFormData(p => ({...p, endereco: e.target.value}))} className="w-full p-3 border border-slate-300 dark:border-slate-600 rounded-lg text-sm outline-none focus:border-blue-500" />
                                </div>

                                <div>
                                    <label className="text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-widest block mb-1 flex items-center justify-between">
                                        Coordenadas GPS
                                        <button onClick={captureLocation} className="text-blue-600 dark:text-blue-400 flex items-center gap-1 hover:underline"><MapPin size={12}/> Capturar</button>
                                    </label>
                                    <input type="text" value={formData.coordenadas} onChange={e => setFormData(p => ({...p, coordenadas: e.target.value}))} placeholder="-20.000, -40.000" className="w-full p-3 border border-slate-300 dark:border-slate-600 rounded-lg text-sm outline-none focus:border-blue-500" />
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                {step === 2 && (
                    <div className="space-y-6 animate-in fade-in slide-in-from-right-4">
                        <div className="bg-white dark:bg-slate-800 p-5 rounded-xl border border-[#E2E8F0] dark:border-slate-700 shadow-sm">
                            <h3 className="text-sm font-black text-[#1F3B5C] dark:text-slate-100 mb-4">Tipo de Risco</h3>
                                ...
                                {RISK_TYPES.map(rt => (
                                    <button 
                                        ...
                                        className={`p-3 rounded-lg border text-xs font-bold flex flex-col items-center gap-2 transition-all ${
                                            formData.tipo_risco === rt.label ? 'bg-blue-50 border-blue-500 text-blue-700 shadow-sm' : 'bg-slate-50 dark:bg-slate-800/50 border-slate-200 dark:border-slate-700 text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:bg-slate-800'
                                        }`}
                                    >
                            ...
                            {formData.tipo_risco && (
                                <div className="mt-4 p-4 bg-slate-50 dark:bg-slate-800/50 rounded-lg border border-slate-200 dark:border-slate-700">
                                    <p className="text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-widest mb-3">Subtipo Específico</p>
                                        ...
                                        {RISK_TYPES.find(r => r.label === formData.tipo_risco)?.subs.map(sub => (
                                            <button 
                                                ...
                                                className={`px-3 py-1.5 rounded-full text-xs font-semibold border transition-all ${
                                                    formData.sub_tipo === sub ? 'bg-[#1F3B5C] text-white border-[#1F3B5C]' : 'bg-white dark:bg-slate-800 border-slate-300 dark:border-slate-600 text-slate-600 dark:text-slate-400 hover:border-slate-400'
                                                }`}
                                            >
                                                {sub}
                                            </button>
                        ...
                        <div className="bg-white dark:bg-slate-800 p-5 rounded-xl border border-[#E2E8F0] dark:border-slate-700 shadow-sm">
                            <h3 className="text-sm font-black text-[#1F3B5C] dark:text-slate-100 mb-4">Grau de Risco</h3>
                                ...
                                {GRAUS.map(g => (
                                    <div 
                                        ...
                                        className={`p-4 rounded-xl border-2 cursor-pointer transition-all ${
                                            formData.grau_risco === g.id ? `${g.bgColor} ${g.borderColor} shadow-sm` : 'bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700 hover:border-slate-300 dark:border-slate-600'
                                        }`}
                                    >
                                        <div className="flex justify-between items-center mb-1">
                                            <span className={`font-black text-sm ${formData.grau_risco === g.id ? g.textColor : 'text-slate-700 dark:text-slate-300'}`}>{g.label}</span>
                                        </div>
                                        <p className="text-xs text-slate-600 dark:text-slate-400 leading-snug">{g.descricao}</p>
                                    </div>
                                ))}
                            </div>
                        ...
                        <div className="bg-white dark:bg-slate-800 p-5 rounded-xl border border-[#E2E8F0] dark:border-slate-700 shadow-sm">
                            <label className="text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-widest block mb-2">Descrição Técnica do Risco *</label>
                            <textarea 
                ...
                {step === 3 && (
                    <div className="space-y-6 animate-in fade-in slide-in-from-right-4">
                        <div className="bg-white dark:bg-slate-800 p-5 rounded-xl border border-[#E2E8F0] dark:border-slate-700 shadow-sm">
                            <h3 className="text-sm font-black text-[#1F3B5C] dark:text-slate-100 mb-4 flex items-center gap-2">
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                                ...
                                {formData.fotos.length < 5 && (
                                    <button 
                                        ...
                                        className="aspect-square bg-slate-50 dark:bg-slate-800/50 border-2 border-dashed border-slate-300 dark:border-slate-600 hover:border-blue-400 rounded-lg flex flex-col items-center justify-center text-slate-500 dark:text-slate-400 transition-colors"
                                    >
                ...
                {step === 4 && (
                    <div className="space-y-6 animate-in fade-in slide-in-from-right-4">
                        ...
                        <div className="bg-white dark:bg-slate-800 p-5 rounded-xl border border-[#E2E8F0] dark:border-slate-700 shadow-sm flex flex-col md:flex-row gap-6">
                            <div className="flex-1">
                                <h3 className="text-sm font-black text-[#1F3B5C] dark:text-slate-100 mb-4">Prazo Concedido</h3>
                                    ...
                                    {[15, 30, 45, 60, 90].map(d => (
                                        <button 
                                            ...
                                            className={`px-4 py-2 rounded-lg text-sm font-bold border transition-colors ${
                                                formData.prazo_dias === d ? 'bg-[#1F3B5C] text-white border-[#1F3B5C]' : 'bg-slate-50 dark:bg-slate-800/50 border-slate-300 dark:border-slate-600 text-slate-600 dark:text-slate-400'
                                            }`}
                                        >
                                            {d} dias
                                        </button>
                                ...
                                <div className="mt-2 flex items-center gap-2">
                                    <span className="text-xs font-bold text-slate-500 dark:text-slate-400">Outro prazo:</span>
                                    <div className="flex items-center bg-white dark:bg-slate-800 border border-slate-300 dark:border-slate-600 rounded-lg overflow-hidden focus-within:border-blue-500 focus-within:ring-1 focus-within:ring-blue-500">
                                        <input 
                                            type="number" 
                                            min="1"
                                            placeholder="Ex: 20"
                                        ...
                                        />
                                        <span className="bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400 text-xs font-bold px-3 py-2.5 border-l border-slate-300 dark:border-slate-600">dias</span>
                                    </div>
                                </div>
                            </div>
                            
                            <div className="flex-1 bg-[#FFFBEB] dark:bg-amber-900/30 p-4 rounded-xl border border-[#FCD34D]">
                                <p className="text-[10px] font-black text-[#92400E] dark:text-amber-400 uppercase tracking-widest mb-3">Cronograma Calculado</p>
                        ...
                        <div className="bg-white dark:bg-slate-800 p-5 rounded-xl border border-[#E2E8F0] dark:border-slate-700 shadow-sm">
                            <h3 className="text-sm font-black text-[#1F3B5C] dark:text-slate-100 mb-4">Medidas Mitigatórias Sugeridas</h3>
                            <p className="text-xs text-slate-500 dark:text-slate-400 mb-4">Selecione as ações que o responsável deve obrigatoriamente executar dentro do prazo.</p>
                                    ...
                                    return (
                                        <div 
                                            ...
                                            className={`p-3 rounded-lg border cursor-pointer flex gap-3 items-start transition-colors ${
                                                isSelected ? 'bg-blue-50 border-blue-200' : 'bg-slate-50 dark:bg-slate-800/50 border-slate-200 dark:border-slate-700 hover:bg-slate-100 dark:bg-slate-800'
                                            }`}
                                        >
                                            ...
                                            <span className={`text-sm ${isSelected ? 'text-blue-900 font-medium' : 'text-slate-600 dark:text-slate-400'}`}>{m}</span>
                                        </div>
                                    );
                                })}
                            ...
                            <div className="flex gap-2 mt-4">
                                <input 
                                    ...
                                    className="flex-1 p-3 border border-slate-300 dark:border-slate-600 rounded-lg text-sm outline-none focus:border-blue-500" 
                                />
                ...
                {step === 5 && (
                    <div className="space-y-6 animate-in fade-in slide-in-from-right-4">
                        ...
                        <div className="bg-[#FFFBEB] dark:bg-amber-900/30 p-5 rounded-xl border border-[#FCD34D]">
                            <h3 className="text-sm font-black text-[#92400E] dark:text-amber-400 mb-2 uppercase tracking-widest flex items-center gap-2">
                                <ShieldAlert size={16} /> Termo Legal
                            </h3>
                            <p className="text-xs text-[#92400E] dark:text-amber-400 text-justify leading-relaxed mb-4">
                            ...
                            <label className="flex items-center gap-3 bg-white dark:bg-slate-800/60 p-3 rounded-lg border border-amber-200 cursor-pointer">
                                <input 
                                    type="checkbox" 
                        ...
                        <div className="bg-white dark:bg-slate-800 p-5 rounded-xl border border-[#E2E8F0] dark:border-slate-700 shadow-sm">
                            <h3 className="text-sm font-black text-[#1F3B5C] dark:text-slate-100 mb-4">Assinatura do Notificado</h3>
                            
                            <div className="flex gap-2 mb-4 bg-slate-100 dark:bg-slate-800 p-1 rounded-lg">
                                <button onClick={() => setFormData(p => ({...p, modo_assinatura: 'digital'}))} className={`flex-1 p-2 text-sm font-bold rounded-md transition-all ${formData.modo_assinatura === 'digital' ? 'bg-white dark:bg-slate-800 shadow text-blue-600 dark:text-blue-400' : 'text-slate-500 dark:text-slate-400'}`}>✍️ Em Tela</button>
                                <button onClick={() => setFormData(p => ({...p, modo_assinatura: 'impresso'}))} className={`flex-1 p-2 text-sm font-bold rounded-md transition-all ${formData.modo_assinatura === 'impresso' ? 'bg-white dark:bg-slate-800 shadow text-emerald-600' : 'text-slate-500 dark:text-slate-400'}`}>📄 Impresso</button>
                                <button onClick={() => setFormData(p => ({...p, modo_assinatura: 'recusa'}))} className={`flex-1 p-2 text-sm font-bold rounded-md transition-all ${formData.modo_assinatura === 'recusa' ? 'bg-white dark:bg-slate-800 shadow text-red-600 dark:text-red-400' : 'text-slate-500 dark:text-slate-400'}`}>✋ Recusou</button>
                            </div>
                            ...
                            {formData.modo_assinatura === 'digital' && (
                                <div className="border border-slate-300 dark:border-slate-600 rounded-xl p-4 bg-slate-50 dark:bg-slate-800/50 flex flex-col items-center">
                                    {formData.sign_notificado ? (
                                        <div className="relative border border-green-200 bg-white dark:bg-slate-800 rounded-lg p-2">
                            ...
                            {formData.modo_assinatura === 'recusa' && (
                                <div className="bg-red-50 p-4 rounded-xl border border-red-200">
                                    ...
                                    <div className="space-y-4">
                                        <div className="bg-white dark:bg-slate-800 p-4 rounded-lg border border-red-100 flex flex-col gap-2">
                                            <p className="text-xs font-bold text-slate-500 dark:text-slate-400 uppercase mb-2">Testemunha 1</p>
                                        ...
                                        <div className="bg-white dark:bg-slate-800 p-4 rounded-lg border border-red-100 flex flex-col gap-2">
                                            <p className="text-xs font-bold text-slate-500 dark:text-slate-400 uppercase mb-2">Testemunha 2</p>
                ...
                <div className="fixed bottom-0 left-0 w-full bg-white dark:bg-slate-800 border-t border-slate-200 dark:border-slate-700 p-4 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)] z-30">
                    <div className="max-w-7xl mx-auto flex justify-between items-center gap-4">
                        <button 
                            ...
                            disabled={salvando}
                            className="px-6 py-3 rounded-lg font-bold text-slate-600 dark:text-slate-400 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 disabled:opacity-50 transition-colors"
                        >
                            Voltar
                        </button>
            ...
            {modalVistoriaOpen && (
                <div className="fixed inset-0 bg-black/60 z-50 flex items-center justify-center p-4">
                    <div className="bg-white dark:bg-slate-800 rounded-2xl w-full max-w-lg shadow-2xl flex flex-col max-h-[80vh]">
                        <div className="p-4 border-b flex justify-between items-center">
                            <h2 className="font-black text-[#1F3B5C] dark:text-slate-100 flex items-center gap-2">
                        ...
                        <div className="p-4 border-b bg-slate-50 dark:bg-slate-800/50 flex gap-2">
                            <input 
                                type="text" 
                                value={buscaOrigem}
                                ...
                                className="flex-1 p-3 border border-slate-300 dark:border-slate-600 rounded-lg text-sm bg-white dark:bg-slate-800 outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
                                autoFocus
                            />
                        ...
                        <div className="p-4 overflow-y-auto flex-1 bg-white dark:bg-slate-800 space-y-2">
                            {buscandoOrigens ? (
                                <div className="text-center text-slate-500 dark:text-slate-400 text-sm py-10">Buscando registros...</div>
                                ...
                                origensEncontradas.map(v => (
                                    <div 
                                        ...
                                        className="p-4 border border-slate-200 dark:border-slate-700 rounded-xl cursor-pointer hover:bg-blue-50 hover:border-blue-200 transition-colors"
                                    >
                                        <div className="flex justify-between items-start mb-1">
                                            <div className="flex gap-2 items-center">
                                                ...
                                                <span className="font-black text-sm text-[#1F3B5C] dark:text-slate-100 bg-slate-100 dark:bg-slate-800 px-2 py-0.5 rounded-md">#{v.titulo_id}</span>
                                            </div>
                                            {v.nivel_risco && (
                                        ...
                                        <p className="text-sm text-slate-700 dark:text-slate-300 font-bold mt-2">{v.solicitante || 'Sem solicitante'}</p>
