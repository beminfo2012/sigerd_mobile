...
// [VER: 1.30] Using explicit models/ prefix and stable v1 API
...
export const refineReportText = async (text, category = 'Geral', context = '') => {
    ...
    try {
        ...
        // [VER: 1.30] Expose model and detailed error for user feedback
        throw new Error(`[IA-v1.30] Erro com models/flash-v1: ${error.message || error.toString()}`);
    }
};
